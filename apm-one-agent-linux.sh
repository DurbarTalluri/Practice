...
DOTNETCORE_AGENT_DOWNLOAD_PATH="https://github.com/DurbarTalluri/Practice/blob/main/apminsight-dotnetcoreagent-linux.sh"
DOTNETCORE_AGENT_CHECKSUM="https://github.com/DurbarTalluri/Practice/blob/main/apminsight-dotnetcoreagent-linux.sh.sha256"
